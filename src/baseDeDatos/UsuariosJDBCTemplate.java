...
//import com.mysql.jdbc.jdbc2.optional.MysqlDataSource;  // Versi�n mysql-connector-java-5.1.17-bin
import com.mysql.cj.jdbc.MysqlDataSource;                // Versi�n mysql-connector-java-8.0.18
...

	   {
	        ...
	        try 
	        {
	            ...
	            String sql = "INSERT INTO Usuario "
	                    + "(nombre, edad, genero, apellidos, direccion, fecha, monto, periodo, moneda, cuota, TEA, fechaVencimiento) "
	                    + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	            ...
	            ps.setDate(6, java.sql.Date.valueOf(user.getFecha())); // formato "YYYY-MM-DD"
	            ps.setDouble(7, user.getMonto());
	            ps.setInt(8, user.getPeriodo());
	            ps.setString(9, user.getMoneda());
	            ps.setDouble(10, user.getCuota());
	            ps.setInt(11, user.getTEA());
	            ps.setDate(12, java.sql.Date.valueOf(user.getFechaVencimiento()));
	            ...
	            while ( resultSet.next() ) 
	             {
	                ...
	                System.out.println( "Conexión IP: " + IP );
	                System.out.println( "Fecha de Último intento: " + fecha );
